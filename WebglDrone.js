...
window.onload = function init()
{
	...
	document.getElementById("Button15").onclick = function() { at[0] =0.0; at[1] =0.0; at[2] =0.0;};
	document.getElementById("Button16").onclick = function() {eye[0]= 0.0; eye[1] = 0.5; eye[2] = 1.0;};
